...
<div class="card shadow mb-5">
    <div class="card-header py-4" style="text-align: center; background-color : #987661; color: white; font-weight:bold; font-size: larger; border-top-left-radius: 1rem; border-top-right-radius: 1rem;">Data Alternatif</div>
    <div class="card-body">
        <a href="dashboard.php?url=tambahalternatif" class="btn btn-success btn-icon-split" style="background: #88603C">
        ...
        <div>
            <p style="color: black; font-weight: bold">Tabel Berikut Ini Menampilkan Nama - Nama Cafe Yang Akan Dievaluasi.</p>
        <div>
          ...
          <table class="table table-bordered">
              <thead>
                 <tr>
                    ...
                    <th scope="col" style="color: black">Nama Cafe</th>
