...
<head>
  ...
  <link rel="icon" href="assets/img/logo-jawaa2.png">
              ...
              <div class="col-lg-12">
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <input type="submit" class="btn btn-secondary btn-user btn-block" name="login" value="LOGIN" style="background: #987661; font-weight: bold;">
